...
<form>
    ...
    <div id="offSpec" class="question" hidden>
        ...
        <div id="offSpecClass" class="questionAnswer" style="display:inline" hidden>
    ...
    <div id="offSpecProf" class="question" hidden>
        <div style="height:100px;" class="questionAsk">
    ...
    <div id="altClasses" class="question">
        <div style="height: 150px;" class="questionAsk">
        ...
        <div style="width: 300px; float: left; margin-left: -19px" class="questionAnswer">
            <select name="dkSpec1" style="display:none;" id="Death Knight1">
                <option value="Blood">Blood</option>
                <option value="Frost">Frost</option>
                <option value="Unholy">Unholy</option>
            </select>
            <select name="druidSpec1" style="display:none;" id="Druid1">
                <option value="Balance">Balance</option>
                <option value="Feral">Feral</option>
                <option value="Guardian">Guardian</option>
                <option value="Restoration">Restoration</option>
            </select>
            <select name="hunterSpec1" style="display:none;" id="Hunter1">
                <option value="BeastMastery">Beast Mastery</option>
                <option value="Marksmanship">Marksmanship</option>
                <option value="Survival">Survival</option>
            </select>
            <select name="mageSpec1" style="display:none;" id="Mage1">
                <option value="Arcane">Arcane</option>
                <option value="Fire">Fire</option>
                <option value="Frost">Frost</option>
            </select>
            <select name="monkSpec1" style="display:none;" id="Monk1">
                <option value="Brewmaster">Brewmaster</option>
                <option value="Mistweaver">Mistweaver</option>
                <option value="Windwalker">Windwalker</option>
            </select>
            <select name="paladinSpec1" style="display:none;" id="Paladin1">
                <option value="Holy">Holy</option>
                <option value="Protection">Protection</option>
                <option value="Retribution">Retribution</option>
            </select>
            <select name="priestSpec1" style="display:none;" id="Priest1">
                <option value="Discipline">Discipline</option>
                <option value="Holy">Holy</option>
                <option value="Shadow">Shadow</option>
            </select>
            <select name="rogueSpec1" style="display:none;" id="Rogue1">
                <option value="Assassination">Assassination</option>
                <option value="Combat">Combat (Outlaw)</option>
                <option value="Subtlety">Subtlety</option>
            </select>
            <select name="shamanSpec1" style="display:none;" id="Shaman1">
                <option value="Elemental">Elemental</option>
                <option value="Enhancement">Enhancement</option>
                <option value="Restoration">Restoration</option>
            </select>
            <select name="warlockSpec1" style="display:none;" id="Warlock1">
                <option value="Affliction">Affliction</option>
                <option value="Demonology">Demonology</option>
                <option value="Destruction">Destruction</option>
            </select>
            <select name="warriorSpec1" style="display:none;" id="Warrior1">
                <option value="Arms">Arms</option>
                <option value="Fury">Fury</option>
                <option value="Protection">Protection</option>
            </select>
    ...
    <div id="attendance" class="question">
        <div style="height: 50px;" class="questionAsk">
    ...
    <div id="challengeModes" class="question">
        <div style="height: 90px;" class="questionAsk">
    ...
    <div class="buttonHolder" style="width: 820px; height: 50px;float:left" >
    </div>
    <button style="display: inline" class="button-submit" type="submit" value="dicks">dicks</button>
